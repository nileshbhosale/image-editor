...
def generate_image():
    ...
    testimonial_transformations = [{ "width": 629,
        "crop": "scale"}]
    testimonial_transformations.extend(
        add_image_transformations(image_url="https://res.cloudinary.com/imageeditor/image/upload/w_200,h_200/v1657257782/cld-sample.jpg",
        gravity="north_west",x = 427, y = 205, width=200, height =200, opacity=100))
    testimonial_transformations.extend(
        add_text("This Zoots !", "north_west", x=157, y=433))

    # Decide the background image
    image = CloudinaryImage("office-background_ol9cdy").image(
